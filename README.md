...
> класс для рисования символоми в консоли 
...
аргументы:
 - `point1`(tuple) - кортеж с коордитатами 1 точки где 0 элемент это X, а 1 элемент это Y
 - `point2`(tuple) - кортеж с коордитатами 2 точки где 0 элемент это X, а 1 элемент это Y
 - `color` (tuple) - цвет символов линии где 0 элемент это начало ANSI кода (перед символом), а 1 его конец (после символа).
...
**вывод текста:**
выводит текст на экран где каждый синвол имеет свои координаты
```python
